...
boundaryLayer = QgsMapLayerRegistry.instance().mapLayersByName('t_216_TVDI_200003.tif')[0]
climitsLayer = QgsMapLayerRegistry.instance().mapLayersByName('t_216_TVDI_200003.tif')[0]
otherLayers = ['t_216_TVDI_200003.tif', 't_216_TVDI_200012.tif', 't_216_TVDI_200011.tif']
count = 0
